...
public sealed class Paths
{
    ...
    public string SettingsPath { get; }      // %LOCALAPPDATA%\NEZ\settings.json
    public string LogDir { get; }            // %LOCALAPPDATA%\NEZ\logs
    ...
    private Paths(string exeDir, string root)
    {
        ...
        var nez = Path.Combine(local, "NEZ");
    ...
    public static Paths InitFromExecutable()
    {
        ...
        // exeDir = ...\NEZ.Shell\bin\Debug\net8.0-windows\ など
        // ルートは 「NEZ-DeepSeekOCR」 フォルダ
